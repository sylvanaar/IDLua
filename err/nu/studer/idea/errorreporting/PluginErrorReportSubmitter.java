...
public class PluginErrorReportSubmitter extends ErrorReportSubmitter {
    ...
    @NonNls
    private static final String SERVER_LOOKUP_URL = "http://www.sylvanaar.com/errorReceiverRedirect.txt";
    @NonNls
    private static final String FALLBACK_SERVER_URL = "http://errors.sylvanaar.com:8080/errorReceiver/";
    @NonNls
