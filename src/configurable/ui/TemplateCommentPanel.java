...
import com.maddyhome.idea.Lua.LuaManager;
import com.maddyhome.idea.Lua.LuaProfile;
import com.maddyhome.idea.Lua.options.LanguageOptions;
import com.maddyhome.idea.Lua.options.Options;
import com.maddyhome.idea.Lua.pattern.EntityUtil;
import com.maddyhome.idea.Lua.pattern.VelocityHelper;
...
public class TemplateCommentPanel implements SearchableConfigurable {
  ...
  public TemplateCommentPanel(FileType fileType, TemplateCommentPanel parentPanel, String[] locations, Project project) {
    ...
    myNoLua.addActionListener(listener);
  ...
  private int getOverrideChoice() {
    return myUseDefaultSettingsRadioButton.isSelected()
           ...
           : myNoLua.isSelected() ? LanguageOptions.NO_Lua : LanguageOptions.USE_TEXT;
  }
  ...
  private void showPreview(LanguageOptions options) {
    final String defaultLuaText = myNoLua.isSelected() ? "" : FileTypeUtil
      .buildComment(fileType, VelocityHelper.evaluate(null, null, null, EntityUtil.decode(LuaProfile.DEFAULT_Lua_NOTICE)), options);
    preview.setText(defaultLuaText);
  }
  ...
  public void reset() {
    ...
    myNoLua.setSelected(fileTypeOverride == LanguageOptions.NO_Lua);
