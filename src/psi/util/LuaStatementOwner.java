 ...
 * @author ilyas
 */
public interface LuaStatementOwner extends LuaElement {

 LuaStatement addStatementBefore(@NotNull LuaStatement statement,LuaStatement anchor) throws IncorrectOperationException;
