 ...
 */
public class LuaLogTab extends AdditionalTabComponent {

    private static final Logger logger = Logger.getInstance("com.sylvanaar.idea.Lua.run.LuaLogTab");
    ...
    public LuaLogTab(Project project, File file) {
