...
// * Time: 4:15:37
// */
//public class LuaReloadAction extends AnAction {
//
...
//                LuaProcessHandler processHandler = (LuaProcessHandler) runContentDescriptor.getProcessHandler();
//                LuaServerDescriptor descriptor = processHandler.getDescriptor();
//
...
//    }
//
//    private void validateDescriptor(LuaServerDescriptor descriptor) throws ReloadException {
//
//        VirtualFile executable = LocalFileSystem.getInstance().findFileByPath(descriptor.getExecutablePath());
//        if (executable == null) {
//            throw new ReloadException(LuaBundle.message("run.error.badpath"));
//        }
//
//    }
//
//    private void testConfig(final LuaServerDescriptor descriptor, final ConsoleView console, Project project) throws ReloadException, IOException {
//
...
//
//        if (exitValue != 0) {
//            throw new ReloadException(LuaBundle.message("run.validationfailed"));
//        }
//
//    }
//
//    private void doReload(LuaServerDescriptor descriptor, ConsoleView console, Project project) throws ReloadException, IOException {
//
//        VirtualFile executableFile = LocalFileSystem.getInstance().findFileByPath(descriptor.getExecutablePath());
//        PlatformDependentTools pdt = ApplicationManager.getApplication().getComponent(PlatformDependentTools.class);
