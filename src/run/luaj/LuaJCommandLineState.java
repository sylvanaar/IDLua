...
public class LuaJCommandLineState extends LuaCommandLineState {
    private static final Logger log = Logger.getInstance("Lua.LuaJCommandLineState");

    public LuaJCommandLineState(LuaRunConfiguration runConfiguration, ExecutionEnvironment env) {
