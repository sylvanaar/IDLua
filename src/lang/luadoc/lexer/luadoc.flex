...
<COMMENT_DATA_START> {WHITE_DOC_SPACE_NO_NL}*(--+){WHITE_DOC_SPACE_NO_NL}* { return LDOC_WHITESPACE; }
...
<DOC_TAG_VALUE, TAG_DOC_SPACE> {WHITE_DOC_SPACE_NO_NL}+ { yybegin(COMMENT_DATA); return LDOC_WHITESPACE; }
<DOC_TAG_VALUE> {NON_WHITE_DOC_SPACE_CHAR}+ { yybegin(COMMENT_DATA); return LDOC_TAG_VALUE; }
