...
public class LuaReferenceExpressionImpl extends LuaReferenceElementImpl implements LuaReferenceExpression {
  public LuaReferenceExpressionImpl(@NotNull ASTNode node) {
    ...
    public PsiElement getReferenceNameElement() {
        PsiElement e = findChildByType(LuaElementTypes.FIELD_NAME);
   ...
   @Override
    ...
    public IElementType getDotTokenType() {
        return getDotToken().getNode().getElementType();
    }

    @Override
    public PsiElement getDotToken() {
        return findChildByType(LuaElementTypes.REFERENCE_DOTS);
    }

    @Override
    public void replaceDotToken(PsiElement newDotToken) {

    }

    @NotNull
    @Override
    public LuaResolveResult[] getSameNameVariants() {
        return new LuaResolveResult[0];
    }

    @Override
    public void setQualifierExpression(LuaReferenceExpression qualifierExpression) {
...
////  }
////
////  public LuaExpression replaceWithExpression(@NotNull LuaExpression newExpr, boolean removeUnnecessaryParentheses) {
...
//    ASTNode newNameNode = LuaPsiElementFactory.getInstance(getProject()).createReferenceNameFromText(name).getNode();
...
//  }
//
//  private static class OurResolver implements ResolveCache.Resolver<LuaReferenceExpression, LuaDeclaration> {
//    @Override
//    public PsiElement resolve(PsiReference psiReference, boolean incompleteCode) {
//        String name = psiReference.getElement().getText();
//        if (name == null) return LuaResolveResult.EMPTY_RESULT.getElement();
//
//
//        return null;  //To change body of implemented methods use File | Settings | File Templates.
//    }
