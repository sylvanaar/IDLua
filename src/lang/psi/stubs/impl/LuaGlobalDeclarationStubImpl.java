...
//    System.out.println("Global stub: " + name.getString() + "  parent: " + parent.getPsi().toString() );
  }

    @Override
    public String getName() {
        return myName.getString();  //To change body of implemented methods use File | Settings | File Templates.
    }
}
