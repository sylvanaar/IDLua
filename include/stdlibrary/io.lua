...
function open(filename, mode) return file end

---
-- Similar to `io.input`, but operates over the default output file.
function output(file) end
